...
tasks {
    ...
    all {
        ...
        if (this.name.equals("signLinuxX64Publication"))                 { this.mustRunAfter("signMingwX64Publication") }
        if (this.name.equals("signMingwX64Publication"))                 { this.mustRunAfter("signWasmJsPublication") }
