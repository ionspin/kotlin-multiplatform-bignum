(function(root, factory) {
  ...
  function suspendCancellableCoroutine(block_0, continuation) {
    return suspendCancellableCoroutine$lambda_0(block_0)(continuation);
  }
  ...
  function suspendAtomicCancellableCoroutine_0(holdCancellability_0, block_0, continuation) {
    ...
    return suspendAtomicCancellableCoroutine$lambda_0(block_0)(continuation);
  }
  ...
  do try {
    switch (this.state_0) {
      ...
      case 5:
        this.local$tmp$_0 = (tmp$_0 = this.local$index , this.local$index = tmp$_0 + 1 | 0 , tmp$_0);
        this.state_0 = 6;
        this.result_0 = this.local$iterator.next(this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
  ...
  do try {
    switch (this.state_0) {
      ...
      case 2:
        this.state_0 = 3;
        this.result_0 = select$lambda_0(this.local$builder)(this);
        if (this.result_0 === COROUTINE_SUSPENDED) 
          return COROUTINE_SUSPENDED;
        continue;
      case 3:
  ...
  function await_0($receiver, continuation) {
    return suspendCancellableCoroutine$lambda_3(await$lambda($receiver))(continuation);
  }
  function Runnable() {
  }
  Runnable.$metadata$ = {
